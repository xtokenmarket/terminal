...
export interface UniswapV3PoolStateInterface extends utils.Interface {
  functions: {
...
export interface UniswapV3PoolState extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: UniswapV3PoolStateInterface

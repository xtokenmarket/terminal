...
import type { XAssetCLR, XAssetCLRInterface } from '../XAssetCLR'
...
const _abi = [
  ...
  },
  {
    inputs: [
      ...
      },
      {
        ...
        internalType: 'struct xAssetCLR.StakingDetails',
        name: 'stakingParams',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    inputs: [
      {
        internalType: 'bool',
        name: '_rewardsAreEscrowed',
        type: 'bool',
      },
    ],
    name: 'setRewardsAreEscrowed',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'contract IStakedCLRToken',
        name: '',
        type: 'address',
      },
    ],
...
export class XAssetCLR__factory {
  ...
  static createInterface(): XAssetCLRInterface {
    return new utils.Interface(_abi) as XAssetCLRInterface
  }
  static connect(
    address: string,
